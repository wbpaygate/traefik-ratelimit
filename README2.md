...
Плагин сравнивает входяшие запросы со списком правил полученых из кипер или или из конфигурации middleware (при недоступности keeper в момент инициализации)
при совпадении с правилами подсчитывает текущую скорость запросов по правилу,
